...
function createDashboard(optionsMenu) {
    ...
    dashboard.innerHTML = `
        ...
        <div class="dashboard-app">
            ...
            <div class="dashboard-welcome" id="dashboard-welcome">
                ...
                <div
                    class="dashboard-welcome-bg"
                    id="dashboard-welcome-bg"
                ></div>

                <div class="dashboard-welcome-scrim"></div>

                <div class="dashboard-welcome-corner dashboard-welcome-corner-tr">
                    GOOD THINGS<br>AHEAD
                    <span class="dashboard-welcome-corner-line"></span>
                </div>

                <div class="dashboard-welcome-corner dashboard-welcome-corner-bl">
                    SIMPLE<br>SAFE<br>FOR A BRIGHTER YOU
                    <span class="dashboard-welcome-corner-line"></span>
                </div>

                <div class="dashboard-welcome-corner dashboard-welcome-corner-br">
                ...
                <div class="dashboard-welcome-content">
                    ...
                    <div
                        class="dashboard-welcome-star"
                        id="dashboard-welcome-star"
                    >✦</div>
                    ...
                    <div class="dashboard-welcome-divider">
                        <span></span>
                        <i>✦</i>
                        <span></span>
                    </div>

                    <div class="dashboard-welcome-caption">
                    ...
                    <button
                        ...
                        id="dashboard-welcome-continue"
                    >
                        TAP TO CONTINUE
                        <span class="dashboard-welcome-button-icon">
    ...
    const dashboardWelcomeBg =
        dashboard.querySelector('#dashboard-welcome-bg');

    const dashboardWelcomeStar =
        dashboard.querySelector('#dashboard-welcome-star');

    const dashboardWelcomeContinue =
        dashboard.querySelector('#dashboard-welcome-continue');
    ...
    if (dashboardWelcomeBg && DASHBOARD_WELCOME_BACKGROUND_URL) {

        dashboardWelcomeBg.style.backgroundImage =
    ...
    if (dashboardWelcomeStar && DASHBOARD_WELCOME_STAR_URL) {

        dashboardWelcomeStar.textContent = '';
        ...
        dashboardWelcomeStar.appendChild(starImg);

    }

    if (dashboardWelcomeContinue) {

        addPressEffect(dashboardWelcomeContinue);

        dashboardWelcomeContinue.addEventListener(
            'click',
            () => {

                if (dashboardWelcome) {
                    dashboardWelcome.classList.add('is-dismissed');
                }
    ...
    menuItem.addEventListener(
        ...
        async () => {
            ...
            if (dashboardWelcome) {
                dashboardWelcome.classList.remove('is-dismissed');
            }
